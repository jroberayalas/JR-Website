...
{{% alert note %}}
Visual MCMC diagnostics using the bayesplot package [`bayesplot`](https://cran.r-project.org/web/packages/bayesplot/vignettes/visual-mcmc-diagnostics.html) package.
{{% /alert %}}
