...
$$\begin{eqnarray} { D }_{ i } & \sim  & Normal({ \mu  }_{ i },\sigma ) & \text{<- likelihood } \\ { \mu  }_{ i } & = & \alpha +{ \beta  }_{ R }{ R }_{ i }+{ \beta  }_{ A}{ A }_{ i } & \text{<- linear model } \\ \alpha  & \sim  & Normal(10,10) & \text{<- }\alpha \text{ prior } \\ { \beta  }_{ R } & \sim  & Normal(0,1) & \text{<- }{ \beta  }_{ R }\text{ prior } \\ { \beta  }_{ A } & \sim  & Normal(0,1) & \text{<- }{ \beta  }_{ A } \text{ prior} \\ \sigma  & \sim  & Cauchy(0,1) & \text{<- }\sigma \text{ prior } \end{eqnarray}$$
...
$$\begin{eqnarray} { R }_{ i } & \sim  & Normal({ \mu  }_{ i },\sigma ) & \text{<- likelihood } \\ { \mu  }_{ i } & = & \alpha +{ \beta  }_{ A}{ A }_{ i } & \text{<- linear model } \\ \alpha  & \sim  & Normal(0,10) & \text{<- }\alpha \text{ prior } \\ { \beta  }_{ A } & \sim  & Normal(0,1) & \text{<- }{ \beta  }_{ A } \text{ prior} \\ \sigma  & \sim  & Cauchy(0,1) & \text{<- }\sigma \text{ prior } \end{eqnarray}$$
